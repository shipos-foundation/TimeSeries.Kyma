...
namespace RaaLabs.TimeSeries.Kyma
{
    ...
    public class InvalidSentenceChecksum : Exception
    {
        ...
        public InvalidSentenceChecksum(byte actualChecksum, byte expectedChecksum, string sentence) : base($"Checksum '{actualChecksum}' is invalid, expecting '{expectedChecksum}' for sentence '{sentence}'. Please refer to the standard for Kyma.")
        {
